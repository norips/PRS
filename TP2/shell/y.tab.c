...
static const char *const yytname[] = {
    ...
    "OU", "'|'", "IN", "OUT", "OUT_APPEND", "ERR", "ERR_OUT", "'\\n'", "'('",
    "')'", "$accept", "lignecommande", "expression_ou_rien", "expression",
...
#line 1373 "y.tab.c" /* yacc.c:1646  */
        ...
        case 19:
#line 103 "Analyse.y" /* yacc.c:1646  */
        {
            char **p = InitialiserListeArguments();
            (yyval.ListeArgs) = AjouterArg(p, yylval.identificateur);
        }
#line 1382 "y.tab.c" /* yacc.c:1646  */
        ...
        case 20:
#line 108 "Analyse.y" /* yacc.c:1646  */
        {
...
#line 112 "Analyse.y" /* yacc.c:1906  */
